...
function HeroGeometric({
  ...
  title1 = "Track Your",
  title2 = "Daily Habits",
  description = "Build better habits, achieve your goals, and transform your life one day at a time."
}: {
  badge?: string;
  title1?: string;
  title2?: string;
  ...
  return <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/[0.05] via-transparent to-amber-500/[0.05] blur-3xl" />

            <div className="absolute inset-0 overflow-hidden">
                <ElegantShape delay={0.3} width={600} height={140} rotate={12} gradient="from-primary/[0.15]" className="left-[-10%] md:left-[-5%] top-[15%] md:top-[20%]" />
                ...
                <ElegantShape delay={0.7} width={150} height={40} rotate={-25} gradient="from-emerald-500/[0.15]" className="left-[20%] md:left-[25%] top-[5%] md:top-[10%]" />
            </div>
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
                        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <br />
                            <span className={cn("bg-clip-text text-transparent bg-gradient-to-r from-primary/90 via-white/90 to-amber-300 ")}>
                                {title2}
                            </span>
                        </h1>
                    </motion.div>
